...
<body>
	...
	<div class="contact-top text-center">
		<div class="content-contact-top">
			<h3 class="stat-title text-white">Más Informacion</h3>
			<h2 class="stat-title text-white">Mantente informado</h2>
			<p class="text-white w-75 mx-auto">Para recibir novedades sobre el Anime y más información sobre el manga
				llena el formulario y te subscribirás al boletín de información
			</p>
		</div>
	</div>
				...
				<div class="col-lg-6 contact-bottom d-flex flex-column contact-right-w3ls">
					...
					<div class="fv3-contact">
						<div class="row">
							...
							<div class="col-10">
								<h6>email</h6>
								<p>
									<a href="mailto:example@email.com" class="text-dark">snk@mappastudios.com</a>
								</p>
							</div>
						</div>
					</div>
					...
					<div class="fv3-contact">
						<div class="row">
							...
							<div class="col-10">
								<h6>Dirección</h6>
								<p>〒166-0015 Suginami-ku 5-42-18, Edificio Ikeshita-Annex 3º piso, Japón.</p>
							</div>
						</div>
					</div>
					<div class="fv3-contact">
						<div class="wppBtn">
							<a href="http://wa.me/573127775884" target="_blank">
					...
					<div class="contact-top1">
						<form action="#" method="get" class="contact-wthree">
							<div class="form-group d-flex">
								...
								<input class="form-control" type="text" placeholder="Pepito" name="email" required="">
							</div>
							<div class="form-group d-flex">
								<label>
									Email
								</label>
								<input class="form-control" type="email" placeholder="ejemplo@email.com" name="email"
									required="">
							</div>
							<div class="form-group d-flex">
								<label>
							...
							<div class="form-group d-flex">
								...
								<textarea class="form-control" rows="5" id="contactcomment" placeholder="Tu mensaje"
									required></textarea>
							</div>
							<div class="d-flex  justify-content-end">
								<button type="submit" class="btn btn-agile btn-block w-50">Enviar</button>
							</div>
						</form>
					</div>
